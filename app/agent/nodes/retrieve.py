...
from app.agent.state import RetrieveInput, RetrieveUpdate
...
async def retrieve_docs(state: RetrieveInput) -> RetrieveUpdate:
    """Read the rewritten query and return raw retrieval documents."""
    query = state["query"]
